    ...
    <footer className="bg-white border-t border-secondary-200">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-secondary-900 mb-4">FreelanceHub</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-secondary-900 mb-4">For Freelancers</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/dashboard/edit-profile" className="text-secondary-600 hover:text-primary-600">
                  Create Profile
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-lg font-semibold text-secondary-900 mb-4">For Clients</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/dashboard/post-job" className="text-secondary-600 hover:text-primary-600">
                  Post a Job
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-lg font-semibold text-secondary-900 mb-4">Resources</h3>
            <ul className="space-y-2">
              <li>
